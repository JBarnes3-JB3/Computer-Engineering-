        ...
        if (inChar == 'w'){        // FORWARD                       // STANDARD DRIVE CONTROLS
            ...
            for(i=0; i<=180; i+=2){ //COLLECT SCAN DATA
                ...
                if ((scanData_fullIR[i/2] < scanThresh) && (ping < scanThresh) ){
                    ...
                    if(25<abs(scanData_fullIR[i/2]-scanData_fullIR[lastInd]) ){  //TODO
                        flag=0;
                    }
...
//                }
                ...
                while(forward>0){
                    ...
                    if(forward>=250){
                        ...
                        //move_forward(sensor, forward-100, spd);  //if checkMate==1?
                    }
...
//                    if(12<abs(scanData_fullIR[i/2]-scanData_fullIR[lastInd]) ){  //TODO
//                        flag=0;
//                    }
